...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        count = count + 1;
        System.out.println("Testint: " + appInfo + " which is " + appDescription +
                " Version: " + appVersion + ". Execution of test method " + count);

        student.setFirstname("Eric");
        student.setLastname("Roby");
        student.setEmailAddress("ericroby@c3n7.games");
    ...
    public void isGradeGreaterStudentGrades() {
        assertTrue(studentGrades.isGradeGreater(95, 90), "failure - should be true");
    }
    ...
    public void createStudentWithoutGradesInit() {
        ...
        studentTwo.setEmailAddress("chard.darby@c3n7.tech");
        ;
